...
public class QQHealthView extends View {
    ...
    private void initDefaultParameter() {
        ...
        mSteps = new int[]{1050, 15280, 8900, 9200, 6500, 5660, 9450};
        calculateSteps();
    }
    ...
    private void initPaints() {
        ...
        mArcPaint.setStrokeWidth(mArcWidth);//画笔宽度
    ...
    protected void onDraw(Canvas canvas) {
        ...
        canvas.drawText("截至22:50分已走", mArcCenterX, yPos, mTextPaint);
        ...
        canvas.drawText("25", mArcCenterX, yPos, mTextPaint);
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        mRatio = 450.f / 525.f;//自定义View的宽高比例
    ...
    private void initDemension(int width, int height) {
        mWidth = width;
        mHeight = height;
